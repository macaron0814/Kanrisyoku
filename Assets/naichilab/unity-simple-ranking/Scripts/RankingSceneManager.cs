...
namespace naichilab
{
    public class RankingSceneManager : MonoBehaviour
    {
        ...
        private static bool isSenden = false;
        ...
        void Start()
        {
            ...
            //googleAdmob = GameObject.Find("GoogleAdmob").GetComponent<GoogleAdmob>();
        }

        IEnumerator GetHighScoreAndRankingBoard()
        {
            scoreLabel.text = _lastScore.TextForDisplay;
            captionLabel.text = string.Format("HighScoreRanking", _board.BoardName);
...
//                    Debug.Log(r[COLUMN_SCORE].ToString());
        ...
        public void OnCloseButtonClick()
        {
            ...
            {
                isSenden = true;
                Scene.sceneType = Scene.SCENETYPE.SENDEN;
            }
            else { Scene.sceneType = Scene.SCENETYPE.TITLE; }
